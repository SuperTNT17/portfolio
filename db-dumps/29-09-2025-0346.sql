...
--
-- Host: mariadb
-- Generation Time: Sep 29, 2025 at 01:46 AM
...
(5, 'Muesumonline', 'museumonline.webp', 'Dit is een website waar we aan hebben gewerkt in een groep om te oefenen om samen een website te maken. Er wordt vooral gebruik gemaakt van standaard HTML, CSS en een beetje JS.', 'https://38210.hosts2.ma-cloud.nl/m2-bo-museumonline/index.html'),
